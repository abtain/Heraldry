...
class GlobalizeMigration < ActiveRecord::Migration
  ...
  def self.up
    puts 'This migration could take anywhere from 4 to 30 minutes.'
    ...
    puts 'Finished the first of three things.'
    load_from_csv("globalize_languages", language_data)
    puts 'Finished the second of three things.'
    load_from_csv("globalize_translations", translation_data)
    puts 'Finished the third of three things, the wait is over.'
  end
